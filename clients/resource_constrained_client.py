...
class ResorceConstrainedRayClient(fl.client.NumPyClient):
    """Ray Virtual Client."""
    ...
    def fit(
        ...
        train_end_index = config["train_end_index"]
        ...
        new_example_cnt = train_end_index - train_start_index
        new_replay_store = replay_store[new_example_cnt:] + list(
            range(train_start_index, train_end_index)
        )
        return weights, len(replay_loader), {"replay_store": new_replay_store}
